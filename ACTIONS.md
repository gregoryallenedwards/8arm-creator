...
| 22 | Selling experience as a repo | Both | pending | Explore: what repos, what monetization. Does this go beyond game advice (e.g. expat taxes). Always need a presentation layer (web page). How do people get their data into the LLM? Must be a workflow that walks someone through it, not just information. |
| 23 | Consider removing or narrowing Validation | Allen | pending | Decision: remove Validation entirely, or narrow it to a process for games or memes that could become games. Allen decides. |
