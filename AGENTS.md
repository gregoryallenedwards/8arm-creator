...
**Image strategy:** Codex-generated SVG diagrams are the workhorse; real-build screenshots (Allen captures) are the most credible asset; cover image is Midjourney-or-skip. Facts over hype.
